...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'course-creator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Blogs', path: '/blogs', entity: 'blog', service: AccessServiceEnum.PROJECT, icon: FiFeather },
    ...
    { name: 'Notes', path: '/notes', entity: 'notes', service: AccessServiceEnum.PROJECT, icon: FiFileText },
