...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`CouseMaker v3`}</title>

        <meta
          name="description"
          content="Welcome to CourseMaker v3 - Your comprehensive platform for creating, managing, and selling courses. Register, login, and access exclusive content, all in one place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to CourseMaker v3 - Your comprehensive platform for creating, managing, and selling courses. Register, login, and access exclusive content, all in one place.`}
            </Text>
            <Box
